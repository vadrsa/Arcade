...
{
    public abstract class ObjectManagerWorkitem<TView, TList, TDetails, T> : WorkitemWpfBase
        where TList : IIdEntityViewModel<T>
        where TDetails : class, IEditableObject, IIdEntityViewModel<T>, new()
        where TView : FrameworkElement
    {
        ...
        public ObjectManagerViewModel<TList, TDetails, T> ObjectManagerViewModel { get; private set; }
        ...
        protected override void RegisterViews(IViewContainer container)
        {
            ...
            ObjectManagerViewModel = (ObjectManagerViewModel<TList, TDetails, T>)view.DataContext;
