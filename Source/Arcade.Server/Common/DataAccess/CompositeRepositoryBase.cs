...
namespace Common.DataAccess
{
    ...
    public abstract class CompositeRepositoryBase<T, K1, K2, R, C> : RepositoryBase<T, R, C>, ICompositeRepository<T, K1, K2>
        where T : class
        where R : class
        where C : DataConnection
    {
        public CompositeRepositoryBase(C context) : base(context)
        {
        }
